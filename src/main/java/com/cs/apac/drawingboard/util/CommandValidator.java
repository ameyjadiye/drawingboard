    ...
    public static boolean isValidCommand(Command command) throws InvalidParameters {
        ...
        case "L":
            ...
            try {
                ...
                if (x1 <=0 || y1 <= 0 || x2 <=0 || y2 <= 0) {
                    throw new InvalidParameters("Command must have 4 param, all positive numeric and > 0, Ex. L 1 2 6 2");
                }
        ...
        case "B":
            ...
            try {
                ...
                if (x1 <=0 || y1 <= 0) {
                    throw new InvalidParameters("Command must have 3 param, two positive numeric and > 0 with color char c, Ex. B 10 3 c");
                }
            } catch (NumberFormatException nfe) {
